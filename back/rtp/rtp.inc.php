...
//框架函数目录名称
defined('PATH_PUBLIC_FUNCTION') or define('PATH_PUBLIC_FUNCTION', '/function/');
...
//框架拓展的相对路径（相对于入口文件而言）,默认是'./extend'
defined('PATH_EXTEND') or define('PATH_EXTEND', './extend/');

//框架证书的相对路径（相对于入口文件而言）,默认是'./cert'
defined('PATH_CERT') or define('PATH_CERT', './cert/');
...
//引入必要文件文件
require PATH_FW . PATH_PUBLIC_FUNCTION . 'rtp.function.php';
